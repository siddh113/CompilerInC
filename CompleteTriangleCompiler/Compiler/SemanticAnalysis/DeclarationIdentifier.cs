...
namespace Compiler.SemanticAnalysis
{
    ...
    public class DeclarationIdentifier
    {
        ...
        /// </summary>
        /// <param name="loopCommand">The node to perform identification on</param>
        public void PerformIdentificationOnLoopCommand(LoopCommandNode loopCommand)
        {
            PerformIdentification(loopCommand.LoopCommand);
            PerformIdentification(loopCommand.WhileExpression);
        ...
        public void PerformIdentificationOnQuestionMarkCommand(QuickIfCommandNode quickIfCommand)
        {
            PerformIdentification(quickIfCommand.Expression);
            PerformIdentification(quickIfCommand.EqualCommand);
        }
