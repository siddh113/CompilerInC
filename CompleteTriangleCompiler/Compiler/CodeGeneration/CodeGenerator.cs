...
namespace Compiler.CodeGeneration
{
    ...
    public class CodeGenerator
    {
        ...
        /// <summary>
        /// Generates code for an loopCommand node
        /// </summary>
        /// <param name="loopCommand">The node to generate code for</param>
        private void GenerateCodeForLoopCommand(LoopCommandNode loopCommand)
        {
            ...
            Address loopCommandJumpAddress = code.NextAddress;
            code.AddInstruction(OpCode.JUMP, Register.CB, FalseValue, 0);

            GenerateCodeFor(loopCommand.WhileExpression);
            ...
            Address whileCommandJumpAddress = code.NextAddress;
            code.AddInstruction(OpCode.JUMP, Register.CB, 0, 0);

            code.PatchInstructionToJumpHere(loopCommandJumpAddress);
            code.PatchInstructionToJumpHere(whileJumpAddress);
            code.PatchInstructionToJumpHere(whileCommandJumpAddress);
        }

        /// <summary>
        /// Generates code for an QuickIf command node
        /// </summary>
        /// <param name="quickIfCommand">The node to generate code for</param>
        private void GenerateCodeForQuickIfCommand(QuickIfCommandNode quickIfCommand)
        {
            ...
            Address ExpressionJumpAddress = code.NextAddress;
            code.AddInstruction(OpCode.JUMP, Register.CB, 0, 0);
